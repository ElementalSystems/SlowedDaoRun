...
var ae={
  ...
  clk: ()=>{ tone(.1).f(200,220,200).v(.1,.3,0); tone(.1,'triangle').f(220,200,220).v(.3,.1,0); },  
  note: (nl,mm)=>{ 
    let n=440*Math.pow(1.059,nl);
    tone(.35+Math.random()*.1).f(n,n+20,n-mm).v(.1,.3,0); tone(.1).f(n/2-mm/2,n/2+10,n/2).v(.3,.1,0); 
  },  
}